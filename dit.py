...
class DiT_Llama(nn.Module):
    def __init__(
        ...
        norm_eps=1e-5,
        condition_dim=512,  # Changed from num_classes
    ):
        super().__init__()
        ...
        self.c_embedder = nn.Linear(condition_dim, min(dim, 1024))  # Linear layer for condition vector
    ...
    def forward(self, x, t, c):
        ...
        adaln_input = t.to(x.dtype) + c.to(x.dtype)
...
if __name__ == "__main__":
    ...
    c = torch.randn(2, 512)  # Example condition vector
